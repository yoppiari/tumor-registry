...
export class ExternalSystemsController {
  ...
  @RequirePermissions('INTEGRATION_CREATE')
  @AuditLog('PROCESS_ADMISSION_HL7')
  ...
  @RequirePermissions('INTEGRATION_CREATE')
  @AuditLog('PROCESS_DISCHARGE_HL7')
  ...
  @RequirePermissions('INTEGRATION_CREATE')
  @AuditLog('PROCESS_LAB_RESULTS_HL7')
  ...
  @RequirePermissions('SYSTEM_MONITOR')
  @AuditLog('TEST_DICOM_CONNECTION')
