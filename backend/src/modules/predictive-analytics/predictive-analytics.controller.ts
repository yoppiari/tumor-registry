...
export class PredictiveAnalyticsController {
  ...
  @AuditLog('GENERATE_CANCER_RISK_PREDICTION')
  ...
  @RequirePermissions('ANALYTICS_VIEW')
  @AuditLog('GENERATE_TREATMENT_RESPONSE_PREDICTION')
  ...
  @RequirePermissions('ANALYTICS_VIEW')
  @AuditLog('GENERATE_SURVIVAL_PREDICTION')
  ...
  @RequirePermissions('ANALYTICS_VIEW')
  @AuditLog('GENERATE_RECURRENCE_RISK_PREDICTION')
  ...
  @RequirePermissions('ANALYTICS_VIEW')
  @AuditLog('BATCH_RISK_ASSESSMENT')
