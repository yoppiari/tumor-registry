...
export class ResearchDiscoveryController {
  ...
  @RequirePermissions('RESEARCH_READ')
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_RESEARCHER_PROFILE')
  ...
  @ApiParam({ name: 'userId', description: 'User ID' })
  @RequirePermissions('RESEARCH_READ')
  @AuditLog('UPDATE_RESEARCHER_PROFILE')
  ...
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_RESEARCH_PROJECT')
  async createProject(
    @Request() req,
  ...
  @AuditLog('UPDATE_RESEARCH_PROJECT')
  async updateProject(
    @Request() req,
    @Param('id', ParseUUIDPipe) id: string,
  ...
  @RequirePermissions('RESEARCH_UPDATE')
  @AuditLog('UPDATE_PROJECT_MEMBER')
  ...
  @ApiParam({ name: 'memberId', description: 'Member ID' })
  @RequirePermissions('RESEARCH_UPDATE')
  @AuditLog('REMOVE_PROJECT_MEMBER')
