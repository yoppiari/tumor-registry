...
export class ResearchController {
  ...
  @AuditLog('APPROVE_RESEARCH_REQUEST')
  ...
  @RequirePermissions('RESEARCH_APPROVE')
  @AuditLog('REJECT_RESEARCH_REQUEST')
  ...
  @RequirePermissions('RESEARCH_APPROVE')
  @AuditLog('REQUEST_ETHICS_REVIEW')
  ...
  @RequirePermissions('RESEARCH_CREATE')
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_OBSERVATIONAL_STUDY_REQUEST')
  ...
  @RequirePermissions('RESEARCH_CREATE')
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_OUTCOME_STUDY_REQUEST')
  ...
  @RequirePermissions('RESEARCH_CREATE')
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_REGISTRY_STUDY_REQUEST')
  ...
  @RequirePermissions('RESEARCH_CREATE')
  @HttpCode(HttpStatus.CREATED)
  @AuditLog('CREATE_QUALITY_IMPROVEMENT_REQUEST')
